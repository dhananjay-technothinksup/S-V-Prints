...
<div class="wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tr>
          ...
          <p style="font-size:14px; margin-bottom:3px; margin-top:3px;"><b> &nbsp;DC No. : 1</b></p>  <hr style="border-bottom:1px solid #000; padding:0px; margin:0px;" >
          <p style="font-size:14px; margin-bottom:3px; margin-top:3px;"> <b> &nbsp;DC Date : </b>&nbsp;  <strong>09 Nov 2019</strong></p> <hr style="border-bottom:1px solid #000; padding:0px; margin:0px;">
  ...
  .table-bottom, tr, td{
          ...
          <tr>
            <td colspan="6"> <p style="float:right;"> <b> For S V Prints </b> </p>
            </td>
          </tr>

          <tr>

            <td colspan="6"> <br> <p style="text-align:right"> Authorised Signature</p> </td>
          </tr>
          </tbody>
        </table>
      </div>
...
<br><br>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?php echo base_url() ?>Transactional/delivery_challan_print" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
